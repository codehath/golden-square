...
def test_diary_add_one_entry_no_number():
    diary = Diary()
...
def test_diary_add_one_entry_extract_number():
    diary = Diary()
...
def test_diary_add_four_entries():
    diary = Diary()
    test_entries = []
    for i in range(4):
...
def test_diary_add_four_entries_extract_two_numbers():
    diary = Diary()
...
def test_entries_to_read_return_three_entries():
    ...
    diary_entry_4= DiaryEntry('Title 17', "Today i called the library #07972876156 Today i called the library Today i called the library #07972876156")
    diary.add_entry(diary_entry_1)
    diary.add_entry(diary_entry_2)
    diary.add_entry(diary_entry_3)
    diary.add_entry(diary_entry_4)
...
def test_entries_to_read_return_three_entries_one_too_long():
    diary = Diary()
    expected = []
    diary_entry_1 = DiaryEntry('Title 5', "Today I called the bank")
    diary_entry_2= DiaryEntry('Title 14', "Today I brushed my teeth and then ate bread, I was a bad boy.")
    diary_entry_3 = DiaryEntry('Title 40', "word "*40)
    diary_entry_4= DiaryEntry('Title 17', "Today i called the library #07972876156 Today i called the library Today i called the library #07972876156")
    diary.add_entry(diary_entry_1)
    diary.add_entry(diary_entry_2)
    diary.add_entry(diary_entry_3)
